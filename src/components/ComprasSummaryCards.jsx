export default function ComprasSummaryCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-700 p-6 shadow-sm hover:shadow-md transition-shadow border-l-4 border-l-rose-500">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-700 p-6 shadow-sm hover:shadow-md transition-shadow border-l-4 border-l-purple-500">
        ...
        <div className="flex items-center gap-1.5 mt-1">
            ...
            <p className="text-sm font-semibold text-purple-600 dark:text-purple-400">{ultimaCompraFecha}</p>
        </div>
      </div>
    </div>
  );
